...
add_action('wp_dashboard_setup', 'windowsxp_dashboard_widgets');
function windowsxp_dashboard_widgets()
{
	wp_add_dashboard_widget('windowsxp_help_widget', 'Theme Support & Server Info', 'windowsxp_dashboard_help');
}

function windowsxp_dashboard_help()
{
	$theme = wp_get_theme();
